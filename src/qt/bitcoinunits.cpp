...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("EqPays");
    case mBTC: return QString("Milli-EqPays (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-EqPays (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
