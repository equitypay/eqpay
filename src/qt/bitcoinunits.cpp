...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("EQPAY");
    case mBTC: return QString("mEQPAY");
    case uBTC: return QString::fromUtf8("μEQPAY (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("EquityPays");
    case mBTC: return QString("Milli-EquityPays (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-EquityPays (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
