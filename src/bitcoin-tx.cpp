...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " eqpay-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  eqpay-tx [options] <hex-tx> [commands]  Update hex-encoded eqpay transaction\n" +
            "or:     eqpay-tx [options] -create [commands]   Create hex-encoded eqpay transaction\n" +
            "\n";
